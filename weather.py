...
class Weather:
  ...
  def get_data(self):
    ...
    try:
     respond = requests.get(f"https://api.openweathermap.org/data/2.5/weather?units={self.units}&lat={self.lat}&lon={self.lon}&appid=94887d3b472a40e81dd35185dfe5616e")
